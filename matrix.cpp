...
string CMatrix::MatrixCat(string s) {
	...
	/*int parnthclose = temp.rfind("]");
	while(parnthclose < temp.length()-1){
		temp = temp.substr(temp.find("["), temp.rfind("]")-temp.find("[")+1);
	}*/
...
CMatrix CMatrix::matsinInv(CMatrix &M){
	CMatrix Result(M.nR, M.nC);
	for (int i=0; i<Result.nR; i++) {
		for (int j=0; j<Result.nC; j++)
...
CMatrix CMatrix::matcosInv(CMatrix &M){
	CMatrix Result(M.nR, M.nC);
	for (int i=0; i<Result.nR; i++) {
		for (int j=0; j<Result.nC; j++)
...
CMatrix CMatrix::mattanInv(CMatrix &M){
	CMatrix Result(M.nR, M.nC);
	for (int i=0; i<Result.nR; i++) {
		for (int j=0; j<Result.nC; j++)
...
CMatrix CMatrix::matsinh(CMatrix &M){
	CMatrix Result(M.nR, M.nC);
	for (int i=0; i<Result.nR; i++) {
		for (int j=0; j<Result.nC; j++)
			Result.values[i][j] = sinh(M.values[i][j]);
	}
	return Result;
}

CMatrix CMatrix::matcosh(CMatrix &M){
	CMatrix Result(M.nR, M.nC);
	for (int i=0; i<Result.nR; i++) {
		for (int j=0; j<Result.nC; j++)
			Result.values[i][j] = cosh(M.values[i][j]);
	}
	return Result;
}

CMatrix CMatrix::mattanh(CMatrix &M){
	CMatrix Result(M.nR, M.nC);
	for (int i=0; i<Result.nR; i++) {
		for (int j=0; j<Result.nC; j++)
			Result.values[i][j] = tanh(M.values[i][j]);
	}
	return Result;
}

/*CMatrix CMatrix::mattanhInv(CMatrix &M){
CMatrix Result(M.nR, M.nC);
for (int i=0; i<Result.nR; i++) {
for (int j=0; j<Result.nC; j++)
...
CMatrix CMatrix::matsinhInv(CMatrix &M){
CMatrix Result(M.nR, M.nC);
for (int i=0; i<Result.nR; i++) {
for (int j=0; j<Result.nC; j++)
...
CMatrix CMatrix::matcoshInv(CMatrix &M){
CMatrix Result(M.nR, M.nC);
for (int i=0; i<Result.nR; i++) {
for (int j=0; j<Result.nC; j++)
...
//=================================
//Check if a string is a number. "private"
bool CMatrix::isNumber(string s){
